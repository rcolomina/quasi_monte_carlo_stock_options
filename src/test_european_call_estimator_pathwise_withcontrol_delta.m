# Test del estimador de una opcion call europea usando pathwise con control de varianza
...
%%%VEGA%%%
for i=1:N
	 VEGA(i)=european_call_estimador_pathwise_vega(S0,ST(i),K,rate,T);
endfor
...
%%%RHO%%%
for i=1:N
	 RHO(i)=european_call_estimador_pathwise_rho(S0,ST(i),K,rate,T);
endfor
...
%%%THETA%%%
for i=1:N
	 THETA(i)=european_call_estimador_pathwise_vega(S0,ST(i),K,rate,T);
endfor
