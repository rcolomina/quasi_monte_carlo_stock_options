# SPREAD OPTIONS: CALCULO DELTA primer subyacente
# INPUTS
...
#
function f_retorno = spread_option_delta1_perio(glp,w1,w2,rate,K,S10,S20,delta1,delta2,sigma1,sigma2,ro12,T,param)
	  value=0;
     N=length(glp);
	  for i=1:N
            ...
            value_aux=hstar_delta1(u1,u2,w1,w2,rate,delta1,delta2,S10,S20,sigma1,sigma2,ro12,T,K);
